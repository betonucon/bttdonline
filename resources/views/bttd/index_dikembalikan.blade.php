            ...
            <div class="panel panel-inverse" data-sortable-id="ui-modal-notification-2">
                ...
                <div class="panel-body">
                    ...
                    <div class="alert alert-success fade show m-b-0" style="background:#e0dea5;margin-bottom:1% !important">
                        ...
                        Data BTTD yang telah dikembalikan oleh <b>LOKET</b> merupakan data yang harus direvis sesuai keterangan tertera.
                    </div>
                        ...
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            @foreach($data as $no=>$o)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="ttd"><b>Alasan Pengembalian :</b><br> {{$o['keterangan']}}</td>
                                    <td class="ttd">
